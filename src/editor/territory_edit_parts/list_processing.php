...
?>
    ...
    <?php    // echo $bearb_id.$geb_nr.$geb_inhaber.$ausgabe.$rueckgabe."<br>";  ?>
      ...
      <td <?php if($verk != "3"){ echo 'onclick="editTD('.$bearb_id2.','.$r.')"'; }?>><?php     echo $rueckgabe;  ?></td>  
      <td onclick="deleteP('<?php echo $bearb_id."','".$verk."','".$gebieteid."','".$publLast;  ?>')" id="<?php echo $i++; ?>"> <?php if($verk != "3"){ echo ' <i class="fas fa-trash-alt"></i>';}?></td> 
    </tr>
